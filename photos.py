...
zipcode = '30328'   #Search within 200 miles of this ZIP code


query = '{"query":{"model":"' + model + '","condition":"' + condition + '","options":{},"arrangeby":"Price","order":"asc","market":"US","language":"en","super_region":"north america","lng":33.7488,"lat":84.3877,"zip":"' + zipcode + '","range":0},"offset":0,"count":100,"outsideOffset":0,"outsideSearch":false}'
