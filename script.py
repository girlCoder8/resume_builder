...
# Search for used Tesla Model 3 vehicles with FSD near Atlanta, GA, excluding SR and Performance vehicles.
...
#Rename, the CSV file, read it, parse it, and  then, extract only results needed
# to be updated
